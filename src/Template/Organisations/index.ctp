    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('organisationname') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $organisation->_id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $organisation->_id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $organisation->_id], ['confirm' => __('Are you sure you want to delete # {0}?', $organisation->_id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
